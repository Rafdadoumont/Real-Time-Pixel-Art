...
`, template.innerHTML.trim());
  ...
  function colorIntToABGR(color) {
    const [r, g, b] = colorIntToRgb(color);
    return 255 * Math.pow(2, 24) + b * Math.pow(2, 16) + g * Math.pow(2, 8) + r;
  }
